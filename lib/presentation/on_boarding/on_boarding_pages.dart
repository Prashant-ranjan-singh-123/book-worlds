...
class OnboardingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          backgroundColor: HexColor(AppColor.background),
          body: Stack(
            children: [
              Column(
                ...
                children: [
                  ...
                  ).animate(delay: 600.ms).scale(duration: 1200.ms, curve: Curves.decelerate),
                  SizedBox(
                  ...
                  Expanded(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: HexColor(AppColor.barkbuttonColor),
